      ...
      <div style={{
        ...
        <div style={{ position: "relative", minHeight: "560px" }}>
          ...
          <div className="animate-float" style={{
            ...
            <Image src="/cake-1.png" alt="Birthday cake with photo print" fill style={{ objectFit: "cover" }} />
            <div style={{
          ...
          <div style={{
            ...
            <Image src="/cake-2.png" alt="Chocolate drip cake" fill style={{ objectFit: "cover" }} />
          </div>
